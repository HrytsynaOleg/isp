...
public class PaymentsListUserPageCommand implements ICommand {
    ...
    public PaymentsListUserPageCommand(IPaymentService paymentService, DtoTablesService tableService) {
    ...
    public String process(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            paymentsCount = paymentService.getPaymentsCountByUserId(loggedUser.getId(), PaymentType.IN);
